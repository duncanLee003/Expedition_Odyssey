...
func stackItems(slot):
	...
	var totalAmount = (
		slotItem.inventorySlot.amount
		+ itemInHand.inventorySlot.amount
	)
	...
	if totalAmount <= maxAmount:
		...
		var remaining = totalAmount - maxAmount

		slotItem.inventorySlot.amount = maxAmount

		itemInHand.inventorySlot.amount = remaining
...
func update_journal():
	...
	usb_image.visible = GameState.usb_inserted

	password_image.visible = GameState.robot_password_learned
